  ...
  async function handleAddFreelanceAbsence() {
    ...
    try {
      await addFreelanceAbsence({
        prenom: capitalizeName(freelancePrenom.trim()),
        date: freelanceDate,
        ...
        {page === "admin" ? (
          ...
          <>
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 sm:p-6 mb-8">
              <p className="flex items-center gap-1.5 text-sm font-semibold text-slate-600 uppercase tracking-wide mb-1">
                <ListTodo className="w-4 h-4" /> Renseigner une absence
              </p>
              <p className="text-xs text-slate-400 mb-4">
                Ce répertoire est réservé aux membres en contrat freelance : il permet de renseigner et
                lister une absence, sans le système de remplacement/validation utilisé dans "Absences &
                Remplacements".
              </p>
