...
// Liste complète des prénoms affichés dans "Heures travaillées par personne" (Administration),
// réutilisée pour les suggestions de saisie du prénom dans Planning et Absences & Remplacements.
const ADMIN_TEAM_NAMES = [
  "Alice",
  "Aurore",
  "Boris",
  "Capucine",
...
export default function AbsenceTracker() {
  ...
  const knownNamesNormalized = useMemo(
    () => new Set([...teamMembers, ...ADMIN_TEAM_NAMES, "Ghost"].map(normalizeName)),
    [teamMembers]
  );
  ...
  function resolveKnownName(raw) {
    ...
    for (const known of [...teamMembers, ...ADMIN_TEAM_NAMES, "Ghost"]) {
                ...
                <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 sm:gap-4">
                  <div className="col-span-2">
                    ...
                    <PrenomAutocomplete
                      ...
                      options={[...ADMIN_TEAM_NAMES, "Ghost"]}
